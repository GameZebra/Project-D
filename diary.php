    ...
    <header>
        ...
        <div class="section">
            ...
            while ($row = $result->fetch_assoc()){
                // if($row['blood_before_brekfast']>10){
                //     $before_brekfast='style="background-color: coral;"';
                // }
                // $after_brekfast=$row['blood_after_brekfast'];
                // $before_lunch=$row['blood_before_lunch'];
                // $after_lunch=$row['blood_after_lunch'];
                // $before_dinner=$row['blood_before_dinner'];
                // $after_dinner=$row['blood_after_dinner'];
                // $night=$row['blood_night'];
